...
{
    //This code is taken from nesrak1's repo for UABEANext3 (With permission and slight modifications)
    //Please check them out here: https://github.com/nesrak1/UABEANext/tree/master
    //Their work has been very helpful in this project
    public class MeshToOpenGL
    {
        ...
        public MeshToOpenGL(AssetsFileInstance fileInst, AssetTypeValueField baseField)
        {
            _fileInst = fileInst;
        ...
        private Half UInt16BitsToHalf(ushort value) => new Half(value);
    }
